...
export default function EstatisticasPage() {
  ...
  function generatePdf() {
    ...
    doc.text('SISTEMA M.A.R.Y', W / 2, y, { align: 'center' })
    y += 7
    ...
    for (let i = 1; i <= pageCount; i++) {
      ...
      doc.text(`SISTEMA M.A.R.Y — ${now.toLocaleDateString('pt-BR')} — Pagina ${i} de ${pageCount}`, W / 2, 290, { align: 'center' })
    }

    doc.save(`estatisticas-swat-${toDate}.pdf`)
  }
