...
const BOOT_TEXT = 'SISTEMA M.A.R.Y v3.0 — AUTENTICAÇÃO REQUERIDA'
...
export default function LoginPage() {
  ...
  return (
    <div className="relative h-screen w-screen bg-bg flex flex-col items-center justify-center overflow-hidden">
      {/* Fundo escuro sólido — vídeo e imagem de fundo removidos */}
      <ScanlineOverlay />
          ...
          >
            <div className="logo-ring" style={{ width: 72, height: 72 }}>
              {logoData?.logo ? (
                ...
                <span className="logo-fallback">M.A.R.Y</span>
              )}
            </div>
            <motion.div
