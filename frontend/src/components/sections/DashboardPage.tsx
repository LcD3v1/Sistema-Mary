    ...
    <div className="p-6 space-y-6">
      ...
      >
        <div className="relative z-10">
          ...
          <h1 className="font-orbitron text-2xl font-bold text-gold tracking-widest mb-1">UNIDADE M.A.R.Y</h1>
      ...
      >
        ...
        <StatCard icon={Users}          label="WIN RATE"        value={stats.tacticalWinRate} color="#c9a227" suffix="%" />
          ...
          <div className="p-4">
            ...
            <ResponsiveContainer width="100%" height={200}>
              <BarChart data={barData}>
                ...
                <Bar dataKey="win rate %" fill="#c9a227" radius={[3, 3, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </GlowCard>
